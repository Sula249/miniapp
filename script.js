...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const appTitle = document.querySelector('h1.app-title');
    
    if (tg.initDataUnsafe && tg.initDataUnsafe.user) {
        const userName = tg.initDataUnsafe.user.first_name;
        greetingTitle.textContent = `Привет, ${userName}!`;
    ...
    searchButton.addEventListener("click", () => {
        ...
        greetingTitle.classList.add("flipped");
        appTitle.classList.add("flipped");
        ...
        setTimeout(() => {
            ...
            if (searchButton.innerText === "Начать поиск") {
                ...
                greetingTitle.textContent = "Mini App!";
            ...
            greetingTitle.classList.remove("flipped");
            appTitle.classList.remove("flipped");
